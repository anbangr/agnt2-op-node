...
//   COLD_SLOAD_COST          (2100) - WARM_STORAGE_READ_COST (100) = 2000
//   COLD_SLOAD_COST          (2100)                                = 2100  (SSTORE surcharge)
...
///
/// Higher than the SLOAD refund because SSTORE's cold surcharge is the full `COLD_SLOAD_COST`
/// (EIP-2929), not the cold-minus-warm delta that SLOAD pays.
